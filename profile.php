<?php
  ...
  if (isset($_POST['save'])) {
    //   $editActive = false;
      ...
      updateUserCountry($data, $connection);
  }
            ...
            <form class="login-form" action<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> method="post">
                <?php
                    if (!$editActive) {
                        ...
                        ?>
                            <div class="set-country-form">
                                <label class="input-label">Your country</label>
                                <p>
                                    <?php 
                                    if (!empty($country)) {
                                        echo $country;
                                ...
                                <input class="edit-button" type="submit" name="edit" value="Edit">      
                            </div>
                        <?php
                    } else {
                        ?>
                        <label class="input-label">Set your country</label>
                        <select class="form-input country" id="country" name="country">
                        <?php
