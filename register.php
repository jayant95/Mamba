<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $user['country'] = !empty($_POST['country']) ? $_POST['country'] : "";
        ...
        if (empty($user['country'])) $errors[] = "Country is required";
  ...
  <div class="container-login background-image register overlay">
		...
		<div class="wrap-input small">
          ...
          <div class="wrap-input">
            ...
            <label class="input-label small">Minimum of 8 characters. At least one captial letter, one lowercase letter, one special character (such as !@$), and one number</label>
